	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<div class="col-md-6">
						<form class="form-horizontal" method="post" action="{{url('admin/admin-update')}}">
						<input type="hidden" name="id" value="{{$adminDetail->id}}">
						{{ csrf_field() }}
							<div class="card-body">
								...
								<div class="form-group row">						
									...
									<div class="col-sm-9">
										<select class="select2 form-control" name="type" id="typeEdit">
											@if($adminDetail->type =="Admin")
											<option value="Admin" data-select2-id="93" selected>Admin</option>
											@endif
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="username" name="username" placeholder="Username" value="{{$adminDetail->username}}">
								...
								<div class="form-group row" id="accessEdit">
                                    <label for="lname" class="col-sm-3 text-right control-label col-form-label">Access</label>
                                    <div class="col-md-9">
                                        <div class="custom-control custom-checkbox mr-sm-2">
											@if($adminDetail->products_access ==1)
                                            <input type="checkbox" checked class="custom-control-input" id="customControlAutosizing1" name="products_access" value="1">
											@else
                                        ...
                                        <div class="custom-control custom-checkbox mr-sm-2">
											@if($adminDetail->categories_access ==1)
                                            <input type="checkbox" checked class="custom-control-input" id="customControlAutosizing2" name="categories_access" value="1">
											@else
                                        ...
                                        <div class="custom-control custom-checkbox mr-sm-2">
											@if($adminDetail->orders_access ==1)
                                            <input type="checkbox" checked class="custom-control-input" id="customControlAutosizing3" name="orders_access" value="1">
											@else
										...
										<div class="custom-control custom-checkbox mr-sm-2">
											@if($adminDetail->users_access ==1)
                                            <input type="checkbox" checked class="custom-control-input" id="customControlAutosizing4" name="users_access" value="1">
											@else
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										...
										@if($adminDetail->status ==1)
											<input type="checkbox" checked class="custom-control-input" id="customControlAutosizing5" name="status" value="1">
										@else

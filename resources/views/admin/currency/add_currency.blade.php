...
<div class="container-fluid">
	...
	<div class="col-md-2"></div>
		<div class="col-md-8">
			<div class="card">
				<form  id="add-cms-page" class="form-horizontal" method="post" action="{{url('/admin/add-currency')}}">
					{{csrf_field()}}
					<div class="card-body">
						<h4 class="card-title">Currency Add<span class="validation_error text-danger"></span></h4>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="currency_code" id="currency_code" placeholder="currency code" required>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="exchange_rate" id="exchange_rate" placeholder="exchange rate" required>
							</div>
						</div>
